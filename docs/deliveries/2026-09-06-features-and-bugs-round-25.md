...
- deviations: `devague deviate --list` — `d1`–`d9`, all proposed; deltas `b1`–`b12`, obligations `o1`–`o28`, evidence `e1`–`e48`, all proposed
...
- confirm or reject deviations `d1`–`d9`, obligations `o1`–`o28`, evidence `e1`–`e48`, deltas `b1`–`b12` (all proposed)
